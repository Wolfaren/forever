...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════• :\na•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n\27')
local token = io.read()
if token ~= '' then
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════• :\na•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n\27[0;33;49m')
...
io.write('\27[1;31m •═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,1602536224,1572942385,1227722692,1414888743}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼《𝙨𝙤𝙪𝙧𝙘𝙚 𝙛𝙤𝙧𝙚𝙫𝙚𝙧》")  
...
if text == "/start" then
if not DevSoFi(msg) then
local Namebot = (database:get(bot_id..'Name:Bot') or 'فورايفر') 
local DRAGON_Msg = { 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مبرمج السورس',url="t.me/wolf5124"}}, 
{{text = 'مبرمج السورس', url="t.me/UU_T_U_R_B_O"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = ' 🐺تم ارسال الملصق من •═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n - '..Name
...
send(msg.chat_id_, msg.id_,' 🐺 اصدار سورس فورايفر{ 3x☆}')
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "فورايفر")
...
tdcli_function ({ID = "GetUser",user_id_ = 1227722692,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1227722692, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == "ولفارين" or text == "بروف" then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 1602536224,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1602536224, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
local Text = [[
مطورين ومبرمجين سورس فورايفر اتبع الازرار للتواصل معهم ⬇️🧿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'زوز مطور السورس',url="t.me/Zoooooooooo0oooooooooooooooooooZ"}},
{{text = 'ولفارين مبرمج السورس',url="t.me/wolf5124"}},
{{text = 'تيربو مطور السورس',url="t.me/UU_T_U_R_B_O"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[  
 🐺 اهلا في قائمه الالعاب المتطوره سورس فورايفر 🐺 
...
t = ' 🐺 ملفات السورس فورايفر•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n •═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس فورايفرو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
end --الكود حصري سورس فورايفريعني لو بكتهن راح اعرفك انت الاخذتهن
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•
...
local Teext =[[
 🐺مرحب  بك في مميزات سورس فورايفر 🐺
 🐺 مميزات الخاصه بسورس 🐺
]]
keyboard = {} 
keyboard.inline_keyboard = {
