...
send(msg.chat_id_,msg.id_, ' [ٲقمد من ٲلقمدٲن يبرؤ❤️'.](t.me/wolf5124) ') 
return false
end

if text == ' تربو ' then 
send(msg.chat_id_,msg.id_, ' [ASALIYA 🕊.](t.me/UU_T_U_R_B_O) ') 
return false
end

if text == '😹' or text == '😹😹' or text == '😹😹😹' or text == '😹😹😹😹' or text == '😹😹😹😹😹' then 
send(msg.chat_id_,msg.id_, ' يا لهوي بتكسف🙈❤️ ') 
return false
end
...
if text == 'بحبك' then 
send(msg.chat_id_,msg.id_, ' ونن كمان يروحي 😍♥️ ') 
return false
end

if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'للابد ')
send(msg.chat_id_, msg.id_,'اسمي ['..Namebot..'] .')
return false
end

if text == 'بكرهك' then 
send(msg.chat_id_,msg.id_, ' بس انا بحبك 🥺🖤 عشان انا اجدع منك ') 
return false
end
